...
clusters. Uses `my_colors_15` as the base palette. If the number of
...
``` r
SafeColorPalette(n_clusters = NULL, base_colors = my_colors_15, verbose = TRUE)
```
...
- base_colors:
  ...
  A character vector of base colors. Default is `my_colors_15`.
