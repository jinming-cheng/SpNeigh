...
#' \itemize{
#'   \item \code{mean_knn_dist}: The average distance to the \code{k} nearest neighbors for each point.
#' }
#' Only points with a \code{mean_knn_dist} less than the specified \code{distance_cutoff} are retained.
#'
#' @export
#' @examples
